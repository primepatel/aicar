...
nets = []
for i in range(1, 5):
    with open(f"pick\\m{i}.pickle", "rb") as f:
...
class Car:
    ...
    def reward(self):
        return self.speed**0.1 + self.distance**0.1
    ...
    def simulate(self):
        ...
        while flag:
            ...
            if key[pygame.K_n] == True:
                ...
                car = Car()
            output = nets[self.map%4].activate(car.get_sensor_data())
            ...
            self.write(screen, 30, "Crashed: " + str(car.alive), (480, 30))
            pygame.display.flip()
            clock.tick(120)
